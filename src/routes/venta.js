...
app.post('/crear', async (req, res) => {
    try {
        ...
        <div align="center" style="padding-top:20px;padding-bottom:40px"><img src="https://ticketsdomosportsandbar.com/assets/img/ELEMENTOS/logodos.png" style="height:100px"/></div>
...
// Paso 1: crear la cuenta Standard de domo
app.post('/create-connected-account', async (req, res) => {
    try {
        const account = await stripe.accounts.create({
            type: 'standard', // cuenta propia de domo
            country: 'MX',    // cambia según el país de domo
...
// Paso 2: crear el accountLink para que el domo complete el onboarding
app.post('/create-account-link', async (req, res) => {
    try {
        const accountLink = await stripe.accountLinks.create({
            account: req.body.accountId, // el acct_xxx que guardaste
            refresh_url: 'https://api.ticketsdomosportsandbar.com/venta/reauth', // si el domo cancela
            return_url: 'https://api.ticketsdomosportsandbar.com/venta/success', // si el domo termina
